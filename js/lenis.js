...
(t = this),
	(e = function () {
		...
		class Animate {
			...
			fromTo(t, e, { lerp: i = 0.1, duration: s = 1, easing: o = (t) => t, onStart: n, onUpdate: l }) {
		...
		return class Lenis {
			constructor({
				...
				(this.__isSmooth = !1),
							...
							r.find((t) => {
								...
								return (
									...
									((null === (l = t.classList) || void 0 === l ? void 0 : l.contains("lenis")) &&
										!(null === (r = t.classList) || void 0 === r ? void 0 : r.contains("lenis-stopped")))
								);
							}))
						)
							return;
					...
					(this.emitter = new Emitter()),
					(this.dimensions = new Dimensions({ wrapper: t, content: e, autoResize: v })),
					...
					(this.virtualScroll = new VirtualScroll(s, { touchMultiplier: m, wheelMultiplier: g })),
